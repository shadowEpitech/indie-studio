...
// To Bomberman Irrlicht as a static library, you must define _IRR_STATIC_LIB_ in both the
// Irrlicht Bomberman, *and* in the user application, before #including <irrlicht.h>
